...
const PLANT_ORDER_TABLE = "<plant_order_table name>";
const PLANT_ORDER_TYPE = "PlantOrder";
...
const createPlantOrder = async (payload) => {
  let plantOrders = [];
  ...
  params["RequestItems"][PLANT_ORDER_TABLE] = plantOrders;
  console.log(params);
...
exports.handler = async (event) => {
  try {
    ...
    await createPlantOrder(payload);
